...
struct WaterRenderPass: RenderPass {
  ...
  func render(renderEncoder: MTLRenderCommandEncoder, scene: GameScene, uniforms: Uniforms, params: Params) {
  ...
  func draw(commandBuffer: MTLCommandBuffer, scene: GameScene, uniforms: Uniforms, params: Params) {
    ...
    render(renderEncoder: renderEncoder, scene: scene, uniforms: uniforms, params: params)
