...
class Water: Transformable {
  ...
  init() {
    ...
    let plane = MDLMesh(planeWithExtent: [100, 0.2, 100], segments: [1, 1], geometryType: .triangles, allocator: allocator)
    do {
  ...
  func render(encoder: MTLRenderCommandEncoder, uniforms: Uniforms, params: Params) {
